...
SECRET_KEY = 'django-insecure-z7mk6m8^2#1e$am78h715k=z4peyfj9nryha_zlc@52dg$4^cn'
...
SIMPLE_JWT = {
    ...
    "USER_AUTHENTICATION_RULE": "api.v1.accounts.validators.default_user_authentication_rule",
